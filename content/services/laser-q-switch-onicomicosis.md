...
- **Onicomicosis leve a moderada** en uñas de manos o pies.
- **Engrosamiento y decoloración asociados a infección fúngica.**
- **Persistencia o recaída** en casos que requieren abordaje combinado.

### 4. ¿Cómo es una sesión de Q-Switch para Onicomicosis?
1. **Confirmación diagnóstica:** Evaluación clínica y, si se indica, estudio micológico.
2. **Preparación de la uña:** Limpieza y reducción del grosor cuando hace falta.
3. **Aplicación láser:** Disparos en lámina ungueal y tejido periungueal.
4. **Plan de continuidad:** Control del crecimiento ungueal y pautas de higiene.
