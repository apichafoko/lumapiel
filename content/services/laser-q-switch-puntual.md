...
1. **Identificación de lesión objetivo** y evaluación de diagnóstico diferencial.
2. **Protección ocular y delimitación** exacta del área.
3. **Disparos focales** de alta precisión sobre cada mancha.
4. **Cuidados post:** Crema reparadora y fotoprotección para evitar repigmentación.
